...
export const FeaturedCard = ({onPress}:Props) => {
  return (
    <TouchableOpacity activeOpacity={.5} onPress={onPress} className='flex flex-col items-start
    w-80 h-96 relative' >
...
export const Card = ({onPress}: Props) => {
    return (
     <TouchableOpacity activeOpacity={.5} onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg
    ...
    </View><Image source={images.newYork} className='w-full h-40 rounded-lg'/>
    <View className='flex flex-col mt-2'>
       ...
       <Image source={icons.heart} className='size-8 mr-2' tintColor='#191d31'/>
    </View>
    </View>
     </TouchableOpacity>
    )
